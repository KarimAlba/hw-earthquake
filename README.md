...
- UI на русском; карта Leaflet (маркеры дня + фильтра, popup, sync со списком)
...
| Журнал (`sessions/`) | сессии 1–8 |
| MVP (список / фильтр / детали) | готов в `earthquakes/` |
| Независимое ревью | сессии 3 и 5; фиксы — 4 и 5 |
| Husky + commitlint | сессии 6–7 |
| Leaflet | сессия 8 |
